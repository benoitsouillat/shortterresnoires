...
<head>
    ...
    <body id="puppy-page">
        ...
        <section class="puppy-para">
            ...
            <p class="para-right">
                <a class="btn btn-dark btn-sm" href="../content/ourdog.php" alt="les parents okkaina et rock" style="margin-right: 15px;">Voir les parents</a>
        ...
        <section class="puppy-para">
            <br/>
            <i><p id="price">Le prix d'un chiot de cette portée est fixé à 1200€ pour un mâle</p>
