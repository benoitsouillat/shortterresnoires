...
<head>
    ...
    <body id="puppy-page">
        ...
        <section class="puppy-para">
            <br/>
            <i><p id="price">Le prix d'un chiot de cette portée est fixé à 1500€ </p>
        ...
        ?>
    <script> document.write('<script type="text/javascript" src="../app/puppies.js?d=' + Math.floor(Math.random() * 10) +  '"\><\/script>' ) </script>
