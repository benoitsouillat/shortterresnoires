    ...
    <body class="container-fluid">
        ...
        <main id="accueil-page">
            ...
            <section class="accueil-section-p d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="accueil-p justify-content-center align-items-center w-75">Le Domaine des Terres Noires est un jeune élevage de Cane Corso situé en Haute-Vienne. <br/>
                    Ma priorité est une sélection sérieuse pour l'amélioration de cette race que nous aimons tellement. Nos chiots cane corso à vendre sont disponibles à la réservation
